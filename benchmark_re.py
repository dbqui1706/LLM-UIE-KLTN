...
def inference(user_prompt, re_labels, query):
...
if __name__ == '__main__':
    ...
    for folder in tqdm(folders):
        ...
        re_labels = load_json(label_file)
        re_labels = [x.strip() for x in re_labels if len(x) >= 2]
        ...
        for metadata in tqdm(benchmark_data):
            ...
            predict_entity = inference(user_prompt, re_labels, query)
        ...
        with open('results/result_RE.txt', 'a') as f:
